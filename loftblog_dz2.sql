...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='Состав товара';
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='Товары';

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('2', 'Навигатор Garmin nuvi 2495LT', 'Garmin', '10', '5121', 'Навигатор не только подсказывает Вам, где нужно повернуть, но и реагирует на произносимые Вами команды. Благодаря инновационной функции распознавания речи Вы можете управлять устройством с помощью голоса, не отрывая рук от руля. Активизируйте nuvi 2495 Глонасс (Glonass) с помощью специально настраиваемой команды и начинайте произносить необходимые опции меню, показанные на экране. ', '1');
...
INSERT INTO `product_catid` VALUES ('8', 'Фотоаппараты');
...
CREATE TABLE `users` (
  ...
  `last_update` date NOT NULL COMMENT 'Дата последнего редактирования пользователя',
  PRIMARY KEY (`id`),
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'Владимир', 'Бун', '1980-02-23', 'qwelp@mail.ru', '12345', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('2', 'Дмитрий', 'Бун', '1915-09-11', 'dmail@mail.ru', '65478', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('3', 'Матвей', 'Петров', '1955-09-02', 'dmail_2@mail.ru', '15973', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('4', 'Валентина', 'Орлова', '1990-09-02', 'dmail_3@mail.ru', '12022', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('5', 'Зенаида', 'Ивановна', '1963-09-16', 'dmail_4@mail.ru', '46666', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('6', 'Владислав', 'Макарович', '1996-09-29', 'dmail_5@mail.ru', '33355', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('7', 'Павел', 'Костяков', '1985-09-13', 'dmail_6@mail.ru', '00011', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('8', 'Василий', 'Веревка', '1933-09-10', 'dmail_7@mail.ru', '54699', '1', '2015-09-18', '2015-09-06');
INSERT INTO `users` VALUES ('9', 'Татьяна', 'Карапузова', '1978-09-05', 'dmail_8@mail.ru', '14796', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('10', 'Анастасия', 'Пупкина', '2001-09-05', 'dmail_9@mail.ru', '11111', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('11', 'Антон', 'Васильев', '1970-09-18', 'dmail_10@mail.ru', '25894', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('12', 'Денис', 'Борис', '1971-09-18', 'dmail_11@mail.ru', '11111', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('13', 'Денис', 'Крутыш', '1970-09-18', 'dmail_12@mail.ru', '00000', '1', '2015-09-18', '2015-09-18');
INSERT INTO `users` VALUES ('14', 'Леонид', 'Иванов', '1970-09-18', 'dmail_13@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('15', 'Петр', 'Иванов', '1970-09-18', 'dmail_14@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('16', 'Матвей', 'Петров', '1970-09-18', 'dmail_15@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('17', 'Галя', 'Турецкая', '1970-09-18', 'dmail_16@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('18', 'Елена ', 'Прекрасная', '1970-09-18', 'dmail_17@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('19', 'Елена', 'Романов', '1970-09-18', 'dmail_18@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('20', 'Евения', 'Петрова', '1970-09-18', 'dmail_19@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('21', 'Марину', 'Черкасова', '1970-09-18', 'dmail_120@mail.ru', '12345', '1', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('22', 'Оксана', 'Черкасова', '1970-09-18', 'dmail_121@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('23', 'Юрий', 'Михайлович', '1970-09-18', 'dmail_122@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('24', 'Юрий', 'Курасов', '1970-09-18', 'dmail_123@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('25', 'Юрий', 'Петров', '1970-09-18', 'dmail_124@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('26', 'Юрий', 'Иванов', '1970-09-18', 'dmail_125@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('27', 'Султан', 'Рашидович', '1970-09-18', 'dmail_126@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('28', 'Аня', 'Пупсова', '1970-09-18', 'dmail_127@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('29', 'Александр', 'Кривоглазов', '1970-09-18', 'dmail_128@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
INSERT INTO `users` VALUES ('30', 'Анатолий', 'Чюриков', '1970-09-18', 'dmail_129@mail.ru', '12345', '0', '2015-09-18', '0000-00-00');
